...
while True:
    ...
    hour_vector = clock_hand_vector((hour+second/3600)/12*2*np.pi, hour_hand_length)
    ...
    GMT_vector = clock_hand_vector((gmt_hour+second/3600)/24*2*np.pi, hour_hand_length)
    ...
    plt.arrow(center[0], center[1], GMT_vector[0], GMT_vector[1], linewidth = second_hand_width, color = 'yellow')
